...
import ImageNode from './plugins/image-node/ImageNode.vue';
import {
  codeBlockSchema,
  commonmark,
  imageSchema,
...
![](https://images.unsplash.com/photo-1674574124976-a56d9052c2f8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3270&q=80)
...
useEditor((root) =>
  Editor.make()
    ...
    .use(
      $view(imageSchema.node, () => nodeViewFactory({ component: ImageNode }))
    )
